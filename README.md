...
- Sixty-two recommendation check mappings (59 of the 95 pinned HIPAA framework checks); missing context is explicit. Unknown checks retain their findings without invented Terraform.
